 ...
 techStack: TechStack[] = [
    {
      name: 'Laravel',
      role: 'Backend API',
      description: 'Robust, secure, and scalable server-side architecture of this system.',
    ...
    },
    {
      name: 'Angular',
      role: 'Web Frontend',
      description: 'Dynamic, responsive, and fast single-page application experience.',
    ...
    },
    {
      name: 'Flutter',
      role: 'Mobile Apps',
      description: 'Cross-platform native performance for both Android and iOS from a single codebase.',
    ...
    },
    {
      name: 'Cloud',
      role: 'Infrastructure',
      description: '99.9% uptime, automatic backups, and enterprise-grade security.',
