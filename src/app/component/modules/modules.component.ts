...
export class ModulesComponent implements OnInit {
  ...
  modules = [
    { title: 'Dashboard & Analytics', icon: 'fas fa-chart-line', description: 'Real-time visibility into attendance, approvals, and key HR metrics to support faster, data-driven decisions.' },
    ...
    { title: 'Reports Engine', icon: 'fas fa-file-alt', description: 'Generate customizable reports for leave, loan ledger, salary summaries, and more with real-time accuracy.' }
  ];
